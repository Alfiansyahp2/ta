		...
		<div class="row">
			...
			<div class="col-lg-12" ;>
				...
				<div class='row'>
					...
					$querykatalog = mysqli_query($mysqli, "SELECT kategori.kategori, kue.id_kue, kue.nama_kue, kue.spesifikasi, kue.gambar, kue.harga FROM kategori RIGHT JOIN kue ON kategori.id_kategori = kue.id_kategori WHERE kue.status='on' ORDER BY kue.id_kue DESC;") or die(mysqli_error($mysqli));
            ...
            <div class='card h-100'>
            	...
            	<small class='text-muted'><a href='tambah_keranjang.php?id_kue={$rowkatalog['id_kue']}&redirect=produk.php' class='btn btn-danger'>+Masukan Keranjang</a></small>
                </div>
            </div>
        </div>";
					}
