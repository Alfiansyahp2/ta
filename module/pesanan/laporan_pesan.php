...
$query = "SELECT pesanan_detail.qty, pesanan.nama_penerima, pesanan.no_telp, pesanan.alamat, kue.nama_kue FROM pesanan_detail 
    JOIN pesanan ON pesanan_detail.id_pesanan = pesanan.id_pesanan 
    JOIN kue ON pesanan_detail.id_kue = kue.id_kue 
